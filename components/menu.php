...
<h1><b>Margherita</b> <span class="w3-right w3-tag w3-dark-grey w3-round">R120</span></h1>
<button style="float: right;" type="button">Add To Cart</button>
<p class="w3-text-grey">Fresh tomatoes, fresh mozzarella, fresh basil</p>
<hr>

<h1><b>Formaggio</b> <span class="w3-right w3-tag w3-dark-grey w3-round">R150</span></h1>
<button style="float: right;" type="button">Add To Cart</button>
...
<span class="w3-right w3-tag w3-dark-grey w3-round">R200</span></h1>
<button style="float: right;" type="button">Add To Cart</button>
...
<span class="w3-right w3-tag w3-dark-grey w3-round">R130</span></h1>
<button style="float: right;" type="button">Add To Cart</button>
<p class="w3-text-grey">Special sauce, mozzarella, parmesan, ground beef</p>
<hr>

<h1><b>Ravioli</b> <span class="w3-right w3-tag w3-dark-grey w3-round">R110</span></h1>
<button style="float: right;" type="button">Add To Cart</button>
<p class="w3-text-grey">Ravioli filled with cheese</p>

<hr>

<h1><b>Spaghetti Classica</b> <span class="w3-right w3-tag w3-dark-grey w3-round">R110</span></h1>
<button style="float: right;" type="button">Add To Cart</button>
...
<span class="w3-right w3-tag w3-dark-grey w3-round">R55</span></h1>
<button style="float: right;" type="button">Add To Cart</button>

<p class="w3-text-grey">Ask the waiter</p>
<hr>

<h1><b>Bruschetta</b> <span class="w3-right w3-tag w3-dark-grey w3-round">R80</span></h1>
<button style="float: right;" type="button">Add To Cart</button>
<p class="w3-text-grey">Bread with pesto, tomatoes, onion, garlic</p>


<hr>
<h1><b>Garlic bread</b> <span class="w3-right w3-tag w3-dark-grey w3-round">R90</span></h1>
<button style="float: right;" type="button">Add To Cart</button>
